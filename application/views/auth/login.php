                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Selamat datang, silakan login ke akunmu atau kembali ke <a href="<?= base_url() ?>">Halaman utama.</a></p>
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <?php echo $this->session->flashdata('message'); ?>
                                                <form method="post" action="<?php echo base_url('auth'); ?>">
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="email" name="email" value="<?php echo set_value('email'); ?>" class="form-control email" id="email" placeholder="Email" required>
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-center btn-inline">Login</button>
                                                </form>
                                            </div>
                                        </div>
