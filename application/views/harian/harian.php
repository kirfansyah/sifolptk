                       ...
                       <div class="col-12">
                           <div class="card">
                               <div class="card-header">
                                   <h4 class="card-title">DATA HARIAN</h4>
                               </div>
                                                   ...
                                                   <?php $i = 1;
                                                    foreach ($harian as $app) : ?>
                                                       <tr>
                                                           ...
                                                           <td><?= $app->sts_app == '1' ? '<div class="badge badge-warning">Proses</div>' : '<div class="badge badge-success">Selesai</div>' ?></td>
                                                           <td>
                                                               <a class="btn btn-sm btn-outline-success" href="<?= base_url('harian/cek/') . $app->id ?>"><i class="feather icon-search"></i></a>
